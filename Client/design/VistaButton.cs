...
namespace VistaButtonTest
{
    ...
    public class VistaButton : System.Windows.Forms.UserControl
    {
        ...
        public override Color ForeColor
        {
            ...
            set { mForeColor = value; Invalidate(); }
        }
        ...
        public ContentAlignment ImageAlign
        {
            ...
            set { mImageAlign = value; Invalidate(); }
        }
        ...
        public Size ImageSize
        {
            ...
            set { mImageSize = value; Invalidate(); }
        }
        ...
        public Style ButtonStyle
        {
            ...
            set { mButtonStyle = value; Invalidate(); }
        }
        ...
        public int CornerRadius
        {
            ...
            set { mCornerRadius = value; Invalidate(); }
        }
        ...
        public Color HighlightColor
        {
            ...
            set { mHighlightColor = value; Invalidate(); }
        }
        ...
        public Color ButtonColor
        {
            ...
            set { mButtonColor = value; Invalidate(); }
        }
        ...
        public Color GlowColor
        {
            ...
            set { mGlowColor = value; Invalidate(); }
        }
        ...
        public Image BackImage
        {
            ...
            set { mBackImage = value; Invalidate(); }
        }
        ...
        public Color BaseColor
        {
            ...
            set { mBaseColor = value; Invalidate(); }
        }
        ...
        {
            if (ButtonStyle == Style.Flat && mButtonState == State.None) { return; }
        ...
        {
            if (mButtonState == State.Pressed) { return; }
            SetClip(g);
        ...
        private void VistaButton_MouseLeave(object sender, EventArgs e)
        {
            ...
            if (mButtonStyle == Style.Flat) { mGlowAlpha = 0; }
            mFadeIn.Stop();
            mFadeOut.Start();
        }
        ...
        private void VistaButton_MouseDown(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Left)
            {
                ...
                if (mButtonStyle != Style.Flat) { mGlowAlpha = 255; }
                mFadeIn.Stop();
                mFadeOut.Stop();
                Invalidate();
            }
        ...
        {
            if (ButtonStyle == Style.Flat) { mGlowAlpha = 0; }
        ...
        private void VistaButton_MouseUp(object sender, MouseEventArgs e)
        {
            if (e.Button == MouseButtons.Left)
            {
                ...
                mFadeOut.Stop();
                Invalidate();
                if (calledbykey == true) { OnClick(EventArgs.Empty); calledbykey = false; }
            }
        }
